...
async function GET(request) {
    try {
        ...
        const bookings = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Booking$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Booking"].find({
            studentId: decoded.userId
        }).populate('counselorId').populate('studentId', 'name email').sort({
            appointmentDate: -1
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            bookings
...
async function POST(request) {
    try {
        ...
        const booking = new __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Booking$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Booking"]({
            studentId: decoded.userId,
            counselorId,
        ...
        await booking.save();
        try {
            const { getIO } = await __turbopack_context__.A("[project]/lib/socket.ts [app-route] (ecmascript, async loader)");
            const io = getIO();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__25753fac._.js.map